 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = (sagenes * 48 * 4.445 + arshins * (48 / 3) *
4.445 + vershoks * 4.445) / 100
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    ...
    val minutes = 60 - minutesDepart + minutesArrive
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val truePercent = 1 + percent / 100.0
    return ((initial * truePercent)* truePercent)* truePercent
}
